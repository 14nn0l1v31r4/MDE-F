...
function renderLogin(onNavigateRegister?: () => void) {
  return render(
    <AuthProvider>
...
describe("LoginPage", () => {
  ...
  it("renders login form with link to register", async () => {
    const onNavigateRegister = vi.fn();
    renderLogin(onNavigateRegister);
  ...
  it("calls onNavigateRegister when register link is clicked", async () => {
    const onNavigateRegister = vi.fn();
    renderLogin(onNavigateRegister);
